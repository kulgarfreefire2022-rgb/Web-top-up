       ...
       <h3 class="mb-6 text-lg font-semibold uppercase leading-relaxed tracking-wider ">
          <i class="fa-solid fa-fire fa-beat-fade fa-lg text-warning"></i>&nbsp;Populer</h3>
                    <div class="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-3">
                        ...
                        <a href="{{ env('APP_URL').'/order/'.$category->kode }}" class="bg-featured-game-card relative hover:shadow-sm hover:cursor-pointer overflow-hidden rounded-2xl  hover:ring-yellow-400 duration-300  hover:ring-2 hover:ring-offset-white-500">
                            <div class="flex items-center">
                                <div class="relative h-24 w-24 rounded-lg ring-murky-600 ">
                                    <img alt="{{ $category->nama }}"  width="80px" height="80px"
                                        src="{{ $category->thumbnail }}" decoding="async" data-nimg="fill"
                                        class="!object-cover"
                                    ...
                                    <div class="justify-end object-center">
                                        <p class="w-[100px]truncate text-xs font-semibold text-murky-200 sm:w-[10px] md:w-[2px] md:text-base">
                                            {{ $category->nama }}</p>
                                        <p class="font-light text-[10px] lg:text-[14px] text-warning line-clamp-2">{{ $category->sub_nama }}</p>
                                    </div>
                            </div>
                        </a>
                        @endif
                ...
                <div class="col-sm-11">
                    <ul class="nav nav-pills justify-content-left hide-scrollbar -mb-px flex space-x-1 overflow-auto"
                        ...
                        <li class="nav-item me-1 mt-1 nav-tab" role="presentation">
                            <button
                                class="btn-sm btn-category  flex whitespace-nowrap border-b-2 py-2 px-3 text-sm font-medium outline-none border-primary-500 from-murky-700 to-murky-800 "
                                id="Emoney-tab" data-bs-toggle="tab"
                                data-bs-target="#Emoney" type="button" role="tab" aria-controls="game"
                                aria-selected="true">
                                <small>E-Money</small>
                            </button>
                        </li>
                        ...
                        <li class="nav-item me-1 mt-1 nav-tab" role="presentation">
                            <button
                                class="btn-sm btn-category  flex whitespace-nowrap border-b-2 py-2 px-3 text-sm font-medium outline-none border-primary-500 from-murky-700 to-murky-800 "
                                id="Pasca-tab" data-bs-toggle="tab"
                                data-bs-target="#Pasca" type="button" role="tab" aria-controls="game"
                                aria-selected="true">
                        ...
                        <a href="{{ env('APP_URL').'/order/'.$category->kode }}"
                            ...
                            <div class="blur-sharp ">
                                <div class="relative h-56 sm:h-[14.4rem] md:h-[14.4rem] lg:h-[10.4rem] xl:w-auto ">
                                    <img alt="{{ $category->nama }}" sizes="100vw"
                                        src="{{ $category->thumbnail }}" decoding="async" data-nimg="fill"
                                ...
                                <div class="flex flex-col h-full justify-between no-underline">
                                    ...
                                    <div>
                                        <p class="font-semibold text-white text-[12px] lg:text-[16px] mb-1 line-clamp-2">
                                            {{ $category->nama }}</p>
                                        <p class="font-light text-[10px] lg:text-[14px] text-warning line-clamp-2">{{ $category->sub_nama }}
                                        </p>
                                ...
                                <div class="row">
                                    <div class="col-12" style="font-size:12px !important">
                                        ...
                                        <img src='{{ isset($popup->path) ? $popup->path : "" }}' width="100%"
                                            class="img-fluid">
                                        <span class="text-gray-600">{!! isset($popup->deskripsi) ? $popup->deskripsi : " <p
                                                class='text-center'>
                                                Selamat datang di ".ENV("APP_NAME")." Selamat berbelanja.</p>" !!}
                                        </span>
                                        <div class="col-12 text-end" style="font-size:10px !important"><span>BY {{ ENV('APP_NAME') }} </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
