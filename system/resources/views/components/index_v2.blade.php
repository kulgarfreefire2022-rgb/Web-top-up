...
<div class="container col-md-11">
    <div class="wrapper mt-3 col-sm-12 col-lg-11 mx-auto">
        ...
        <div class="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-3">
            ...
            <a href="{{ env('APP_URL').'/order/'.$category->kode }}" style="outline: none;" class="">
                <div
                    ...
                    <img alt="{{ $category->nama }}" decoding="async"
                        ...
                        sizes="100vw" src="{{ $category->thumbnail }}" style="color: transparent;">
                    <div class="relative flex w-[100px] flex-col sm:w-[150px] md:w-[200px]">
                        <h2 class="truncate text-[10px] md:text-base font-semibold text-text-color">{{ $category->nama }}</h2>
                        <p class="text-[9px] text-text-color md:text-sm">{{ $category->sub_nama }}</p>
                    </div>
                </div>
            </a>
            @endif
                        ...
                        <a href="{{ env('APP_URL').'/order/'.$category->kode }}"
                            ...
                            <div class="blur-sharp ">
                                <div class="relative h-56 sm:h-[14.4rem] md:h-[14.4rem] lg:h-[18rem] xl:w-auto ">
                                    <img alt="{{ $category->nama }}" sizes="100vw" src="{{ $category->thumbnail }}"
                                ...
                                <div class="flex flex-col h-full justify-between no-underline">
                                    ...
                                    <div>
                                        <p
                                            ...
                                            {{ $category->nama }}</p>
                                        <p class="font-light text-[10px] lg:text-[14px] text-warning line-clamp-2">{{
                                            $category->sub_nama }}
                                        </p>
                                ...
                                <div class="row">
                                    <div class="col-12" style="font-size:12px !important">
                                        ...
                                        <img src='{{ isset($popup->path) ? $popup->path : "" }}' width="100%"
                                            class="img-fluid">
                                        <span class="text-gray-600">{!! isset($popup->deskripsi) ? $popup->deskripsi : "
                                            <p class='text-center'>
                                                Selamat datang di ".ENV("APP_NAME")." Selamat berbelanja.</p>" !!}
                                        </span>
                                        <div class="col-12 text-end" style="font-size:10px !important"><span>BY {{
                                                ENV('APP_NAME') }} </span>
                                        </div>
                                    </div>
                                </div>
