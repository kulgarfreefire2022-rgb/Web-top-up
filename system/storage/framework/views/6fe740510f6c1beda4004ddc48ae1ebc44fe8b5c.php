    ...
    <body style="color: rgb(230, 230, 230);">
        <div class="w-full h-[100vh] absolute -z-10 lg:block md:block hidden">
            <img
                ...
                data-nimg="fill"
                class="object-cover"
                style="position: ; height: 100%; width: 100%; inset: 0px; color: transparent;"
            />
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/v2.nvdstoreindonesia.com/system/resources/views/components/register.blade.php ENDPATH**/ ?>