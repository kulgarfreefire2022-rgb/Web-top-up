        ...
        <div class="col-lg-6 mx-auto mt-5">
            <div class="pb-4 ">
                <div class="text-center mb-3">
                    <img src="<?php echo e(!$config ? '' : $config->web_logo); ?>" class="mlImg" alt="" width="150" height="150">
                </div>
                <div class="section">
...
<?php echo $__env->make("main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/hitungwr.blade.php ENDPATH**/ ?>