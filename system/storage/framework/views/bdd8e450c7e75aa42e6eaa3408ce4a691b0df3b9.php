...
<div class="container col-md-11">
    <div class="wrapper mt-3 col-sm-12 col-lg-11 mx-auto">
        ...
        <h3 class="mb-6 text-lg font-semibold uppercase leading-relaxed tracking-wider ">
            <i class="fa-solid fa-fire fa-beat-fade fa-lg text-warning"></i>&nbsp;Populer
        </h3>
        <div class="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-3">
            ...
            <a href="<?php echo e(env('APP_URL').'/order/'.$category->kode); ?>" style="outline: none;" class="">
                <div
                    class="xs:p-[5px] md:p-2 bg-featured-game-card rounded-xl shadow-xl flex items-center gap-x-2 rounded-xl p-1.5 duration-300 ease-in-out hover:shadow-2xl hover:ring-2 hover:ring-primary-600 hover:ring-offset-2 hover:ring-offset-bg-color md:gap-x-3 md:rounded-2xl md:p-3 bg-title-product">
                    <img alt="<?php echo e($category->nama); ?>" decoding="async"
                        ...
                        sizes="100vw" src="<?php echo e($category->thumbnail); ?>" style="color: transparent;">
                    <div class="relative flex w-[100px] flex-col sm:w-[150px] md:w-[200px]">
                        <h2 class="truncate text-[10px] md:text-base font-semibold text-text-color"><?php echo e($category->nama); ?></h2>
                        <p class="text-[9px] text-text-color md:text-sm"><?php echo e($category->sub_nama); ?></p>
                    </div>
                </div>
            </a>
            <?php endif; ?>
        ...
        <div class="row mt-1 mx-auto">
            <div class="col-sm-11">
                <ul class="nav nav-pills justify-content-left hide-scrollbar -mb-px flex space-x-1 overflow-auto"
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600 active"
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600"
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600"
                            id="Pulsa-tab" data-bs-toggle="tab" data-bs-target="#Pulsa" type="button" role="tab"
                            aria-controls="game" aria-selected="true">
                            <small>Pulsa</small>
                        </button>
                    </li>
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600"
                            id="Voucher-tab" data-bs-toggle="tab" data-bs-target="#Voucher" type="button" role="tab"
                            aria-controls="game" aria-selected="true">
                            <small>Voucher</small>
                        </button>
                    </li>
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600"
                            id="Emoney-tab" data-bs-toggle="tab" data-bs-target="#Emoney" type="button" role="tab"
                            aria-controls="game" aria-selected="true">
                            <small>E-Money</small>
                        </button>
                    </li>
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600"
                            id="Pasca-tab" data-bs-toggle="tab" data-bs-target="#Pasca" type="button" role="tab"
                            aria-controls="game" aria-selected="true">
                            <small>Pascabayar</small>
                        </button>
                    </li>
                    ...
                    <li class="nav-item me-1 mt-0 nav-tab me-3 border border-secondary-600 rounded-full" role="presentation">
                        <button
                            class="whitespace-nowrap rounded-full bg-transparent px-4 py-2 pt-1 text-sm shadow-xl outline-none duration-300 hover:bg-secondary-500 focus:bg-secondary-500 focus-visible:bg-secondary-500 !border-transparent !bg-primary-500 text-text-color-foreground hover:!bg-primary-600"
                            id="app-tab" data-bs-toggle="tab" data-bs-target="#App" type="button" role="tab"
                            aria-controls="game" aria-selected="true">
    ...
    <div class="wrapper mt-3">
        <div class="col-lg-11 mt-0 mx-auto">
            <div class="tab-content" id="myTabContent">
                        ...
                        <a href="<?php echo e(env('APP_URL').'/order/'.$category->kode); ?>"
                            ...
                            <div class="blur-sharp ">
                                <div class="relative h-56 sm:h-[14.4rem] md:h-[14.4rem] lg:h-[18rem] xl:w-auto ">
                                    <img alt="<?php echo e($category->nama); ?>" sizes="100vw" src="<?php echo e($category->thumbnail); ?>"
                ...
                <div class="tab-pane" id="Emoney" role="tabpanel" aria-labelledby="Emoney-tab">
                    <div
                        class="mt-3 md:mt-10 grid grid-cols-3 gap-3 sm:grid-cols-4 sm:gap-3 md:grid-cols-5 md:gap-3 lg:grid-cols-6 lg:gap-3 xl:grid-cols-6 xl:gap-5">
                        <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($category->tipe == "e-money"): ?>
                        <a href="<?php echo e(env('APP_URL').'/order/'.$category->kode); ?>"
                            class="featured-game-card relative hover:shadow-sm hover:cursor-pointer  group relative overflow-hidden rounded-2xl  hover:ring-yellow-400 duration-300  hover:shadow-2xl hover:ring-2   hover:ring-offset-white-500">
                            <div class="blur-sharp ">
                                <div class="relative h-56 sm:h-[14.4rem] md:h-[14.4rem] lg:h-[18rem] xl:w-auto ">
                ...
                <div class="tab-pane" id="Pasca" role="tabpanel" aria-labelledby="Pasca-tab">
                    <div
                        class="mt-3 md:mt-10 grid grid-cols-3 gap-3 sm:grid-cols-4 sm:gap-3 md:grid-cols-5 md:gap-3 lg:grid-cols-6 lg:gap-3 xl:grid-cols-6 xl:gap-5">
                        <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($category->tipe == "pasca"): ?>
                        <a href="<?php echo e(env('APP_URL').'/order/'.$category->kode); ?>"
                            class="featured-game-card relative hover:shadow-sm hover:cursor-pointer  group relative overflow-hidden rounded-2xl  hover:ring-yellow-400 duration-300  hover:shadow-2xl hover:ring-2   hover:ring-offset-white-500">
                            <div class="blur-sharp ">
                                <div class="relative h-56 sm:h-[14.4rem] md:h-[14.4rem] lg:h-[18rem] xl:w-auto ">
                    ...
                    <div class="col-12 mb-2">
                        <div class="card text-gray-600 " style="border:1px ;">
                            <div class="card-header">
                                <h5 class="modal-title" id="myLargeModalLabel"><i class="fa fa-bullhorn"
                                        style="color: #FF0000;" aria-hidden="true"></i> Information</h5>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12" style="font-size:12px !important">
                                        ...
                                        <img src='<?php echo e(isset($popup->path) ? $popup->path : ""); ?>' width="100%"
                                            class="img-fluid">
                                        <span class="text-gray-600"><?php echo isset($popup->deskripsi) ? $popup->deskripsi : "
                                            <p class='text-center'>
...
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views/components/index_v2.blade.php ENDPATH**/ ?>