                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active" id="populer" role="tabpanel" aria-labelledby="populer-tab">
                        <div class="row row-cols-3 row-cols-md-6 g-4 justify-content-left mt-2"> <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($category->tipe == "populer"): ?> <div class="col mt-2 mb-4">
                              <div class="col ">
                           <div class="img-scale card bg-transparent border-0 h-100 rounded zoom-cekstore text-center">
                           <a href="<?php echo e(env('APP_URL').'/order/'.$category->kode); ?>">
                                      <img src="<?php echo e($category->thumbnail); ?>" class="card-img-top rounded-img-buy patih" alt="<?php echo e($category->nama); ?>">
                                        </a>
...
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/game.nvdstoreindonesia.com/system/resources/views/components/index.blade.php ENDPATH**/ ?>