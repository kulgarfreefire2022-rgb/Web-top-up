...
<head>
    ...
    <meta name="twitter:image" content="<?php echo e(ENV('APP_LOGOFAVICON')); ?>" />
...
border-color: #e10603 !important;

}

.btn-primary:hover {
color: #fff;
background-color: #952624 !important;
border-color: #952624 !important;
...
<body class=" text-white flex-column min-vh-100 " style="color:#ffffff;scroll-behavior:auto !important;background:#171717">
...
<li>
<a href="<?php echo e(ENV('APP_IG')); ?>" class="text-decoration-none" target="_blank">
...
<li>
<a href="<?php echo e(ENV('APP_WA')); ?>" class="text-decoration-none" target="_blank">
...
<li>
<a href="<?php echo e(ENV('APP_TT')); ?>" class="text-decoration-none" target="_blank">
...
</html><?php /**PATH /home/mysticpe/job.mystic-pedia.net/system/resources/views/main.blade.php ENDPATH**/ ?>