...
background:url('<?php echo e($kategori->event); ?>');
}
...
<div class="wrapper mb-5">
    ...
    <div class="container">
        ...
        <div class="card cekstore-rounded-sedang border-0 games-thumbnail" style="background-image: url('<?php echo e($kategori->bannerlayanan); ?>');">
                ...
                <div class="col-lg-4 mt-2 mb-2">
                    <div class="row">
                     ...
                     <div class="col mt-3 d-lg-block d-none">
                        <div class="card cekstore-rounded-sedang bg-dark shadow d-none">
                            <div class="card-header bg-gradient cekstore-rounded-sedang">
                                        ...
                                        <div class="card flex-row flex-wrap bg-dark">
                                            <div>
                                                <a href="/game/free-fire" class="stretched-link">
                                                    <img src="/assets/thumbnail/ff.jpg" class="card-header2 cekstore-rounded-sedang" alt="call-of-duty-mobile-icon" />
                                                </a>
                                            </div>
                                ...
                                <div class="card flex-row flex-wrap bg-dark d-none">
                                    <div>
                                        <a href="" class="stretched-link">
                                            <img src="" class="card-header2 cekstore-rounded-kecil" alt="call-of-duty-mobile-icon" />
                                        </a>
                                    </div>
                ...
                <div class="list-group1 h-100">
                    ...
                    <label for="SALDO" class="list-group-item h-100">
                        ...
                        <div class="info-bottom text-dark">
                            <span class="text-dark" id="pembay">
                                <div class="cekstore-dicek">
                                    <i>Login untuk menggunakan Mobilegamestore E-Wallet</i>
                                </div>
                            </span>
                        </div>
                    </label>
    ...
    <a class="open-button-action-payment" onclick="openPaymentDrawer(this)">
        <i class="fas fa-chevron-down"></i>
                    ...
                    <div class="w-100 mt-2">
                      <button class="btn btn-primary rounded-cekstore w-100 btn-lg" id="order" type="button">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/game.nvdstoreindonesia.com/system/resources/views/components/order.blade.php ENDPATH**/ ?>