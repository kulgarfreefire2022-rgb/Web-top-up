            ...
            <div class="row">
                ...
                <p><?php echo e(ENV('APP_DES')); ?></p>
                  ...
                  <div class="col-lg-2 p-4">
                    ...
                    <div class="mt-3">
                        ...
                        <i class="fas fa-angle-right"></i> <a href="<?php echo e(route('price')); ?>"
                            class="text-white bjlink ">
                            Price List
                        </a><br>
                    </div>
               ...
               <div class="col-lg-2 p-4">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="text-white bjlink">
                        Login</a><br>
                        <i class="fas fa-angle-right"></i> 
...
</html><?php /**PATH /home/nvdstor2/game.nvdstoreindonesia.com/system/resources/views/main.blade.php ENDPATH**/ ?>