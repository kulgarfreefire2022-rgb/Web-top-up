...
<head>
    ...
    <meta content="<?php echo e(!$config ? '' : $config->web_description); ?>" name="description" />
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    ...
                                    <a href="<?php echo e(route('seting')); ?>" class="dropdown-item">Setting Web</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    ...
                                    <a href="<?php echo e(route('paket.index')); ?>" class="dropdown-item"> Paket</a>
                                    ...
                                    <a href="<?php echo e(route('promo')); ?>" class="dropdown-item"> Flashsale</a>
                                </div>
                            </li>
                            <?php endif; ?>
                        </ul> <!-- end navbar-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; Design & Developed by <a href="https://codeidn.com">codeidn</a>
                        </div>
                        <div class="col-md-6">
...
</html><?php /**PATH /home/tridisos/kiosweb.triwdv.id/system/resources/views/main-admin.blade.php ENDPATH**/ ?>