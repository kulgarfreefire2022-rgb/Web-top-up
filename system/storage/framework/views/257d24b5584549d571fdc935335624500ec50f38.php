        ...
        <div class="col-lg-6 mx-auto mt-5">
            <div class="pb-4 ">
                <div class="text-center mb-3">
                    <img src="<?php echo e(isset($logofooter->path) ? $logofooter->path : ""); ?>" class="mlImg" alt="bosstore" width="150" height="150">
                </div>
                <div class="section">
...
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/demo4.nvdstoreindonesia.com/system/resources/views/components/hitungwr.blade.php ENDPATH**/ ?>