...
box-shadow: inset 1000px 50px 100px 35px #272730;
...
.creativeux-shadow {
    ...
    <body style="color: rgb(230, 230, 230);">
        ...
        <div class="w-full h-[100vh] absolute lg:block md:block z-[9] css-1jh570t">
            <img
                alt="bg-login-line"
                sizes="100vw"
      ...
      Username
                        ...
                        <div class="mb-8 text-[14px] justify-between flex">
                            <div class="flex items-center ml-2">
                                <input required="" type="checkbox" name="tac" id="tac" class="form-check-input">
                                    ...
                                    <i>
                                    I agree to <a href="<?php echo e(route('Terms-and-conditions')); ?>">Terms
                                    and conditions</a>
                                    </i>
                                    </label>
                            </div>
                        ...
                        <button
                          type="submit" name="tombol" value="submit"
                            class="bg-btnPurple hover:bg-yellow-400 mt-3 w-100 inline-flex w-full justify-center rounded-full text-sm font-semibold py-3 px-4 hover:scale-105 duration-300 items-center"
                    ...
                    <a class="inline-flex w-full py-3 px-4 justify-center text-sm font-semibold border rounded-full hover:scale-105 duration-300" href="<?php echo e(route('login')); ?>" style="color: rgb(39, 39, 39); background: rgb(255, 255, 255);">
                        Masuk Sekarang
                    </a>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/demo3.nvdstoreindonesia.com/system/resources/views/components/register.blade.php ENDPATH**/ ?>