             ...
             <div>
                <div class="h-full pt-3 lg:w-80">
                    <div class="text-center pb-2 flex flex-col gap-2 justify-between rounded-2xl p-6 shadow-sm css-scrciq">
                        ...
                        <span class="h6 rounded-md bg-red-600 px-4 py-2 text-center text-white"><b>Tanggal expired:</b><br><?php echo e($expired); ?></span>
                        <?php elseif($data->status_pembelian == "Process"): ?>
                    ...
                    <div class="py-4">
                        <div class="mt-4 mb-4 flex justify-center rounded-lg  py-4 qrCode">
                            ...
                            <?php if(Str::upper($data->metode_pembayaran) == "QRIS" || Str::upper($data->metode_pembayaran) == "QRISC" || Str::upper($data->metode_pembayaran) == "QRIS2" || Str::upper($data->metode_pembayaran) == "QRISOP" || Str::upper($data->metode_pembayaran) == "QRISCOP" ): ?>
                             ...
                             <img src="<?php echo e($data->no_pembayaran); ?>" alt="qrcode" class="relative items-center justify-center overflow-hidden rounded-lg bg-white sm:h-56 sm:w-56" >
                             </a>
...
<?php echo $__env->make("main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views/components/invoice.blade.php ENDPATH**/ ?>