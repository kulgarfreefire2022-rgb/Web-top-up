            ...
            <div class="flex flex-col gap-6">
                <div class="grid grid-cols-12 gap-6">
                    <div class="p-6 col-span-12 md:col-span-6 lg:col-span-8 xl:col-span-8 rounded-2xl css-6qw8qz">
                        <div class="flex justify-between items-center col-span-12 gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex flex-col gap-1">
                                    <h3 class="font-bold text-sm lg:text-lg text-white">Selamat Datang <?php echo e(Auth()->user()->name); ?></h3>
                                    <p class="text-white/70 text-[12px] lg:text-[14px] flex items-center gap-3">
                                        <?php echo e(Str::upper(Auth()->user()->role)); ?>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="font-weight: bold; ">Total Outcome</td><td>:</td><td>
                                        <span class="badge bg-success">Rp <?php echo e(number_format(Auth::user()->balance, 0, ',', '.')); ?></span>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="flex flex-row-reverse justify-end lg:flex-row md:flex-row gap-3 mt-3">
                         <a class="group flex items-center rounded-3xl px-3 py-2 text-sm font-medium btn-primary css-138rpjnn" aria-current="page" href="<?php echo e(url('/user/edit/profile')); ?>">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="p-6 col-span-12 md:col-span-6 lg:col-span-8 flex flex-col lg:flex-row lg:items-center justify-between gap-5 rounded-2xl css-6qw8qz">
                        <div>
                            <p class="text-md font-medium mb-4">Saldo <?php echo e(config('app.name')); ?> </p>
                            <h3 class="text-[24px] lg:text-[26px] font-bold css-m6e15a">Rp <?php echo e(number_format(Auth::user()->balance, 0, ',', '.')); ?>,-</h3>
                        </div>
...
<?php echo $__env->make("main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/dashboarduser.blade.php ENDPATH**/ ?>