...
<main class="my-4 min-h-[60vh]">
                ...
                <div class="h-full pt-3 lg:w-80">
                    <div class="text-center pb-2 flex flex-col gap-2 justify-between rounded-2xl p-6 shadow-sm css-scrciq">
                        ...
                        <?php elseif($data->status_pembelian == "Batal"): ?>
                         ...
                         <?php elseif($data->status_pembelian == "Process"): ?>
                        ...
                        <span class="h6 text-danger"><b>Tanggal expired</b>: <?php echo e($expired); ?></span>
                        <?php elseif($data->status_pembelian == "Process"): ?>
    ...
    <form id="myForm" action="<?php echo e(route('pembelian', ['order' => $data->id_pembelian])); ?>" method="POST">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="py-4">
                        <div class="mt-4 mb-4 flex justify-center rounded-lg  py-4 qrCode">
                            ...
                            <?php if(Str::upper($data->metode_pembayaran) == "QRIS" || Str::upper($data->metode_pembayaran) == "QRISC" || Str::upper($data->metode_pembayaran) == "QRIS2" || Str::upper($data->metode_pembayaran) == "QRISOP" || Str::upper($data->metode_pembayaran) == "QRISCOP" ): ?>
                             ...
                             <a href="<?php echo e($data->no_pembayaran); ?>" download="">
                             <img src="<?php echo e($data->no_pembayaran); ?>" alt="qrcode" class="img-fluid" width="150px" style="margin-left: 42px;">
                             </a>
                            ...
                            <kbd class="bg-dark" data-toggle="tooltip" data-placement="bottom" id="paycode">
                                <td class="col-bjinv2"><a href="<?php echo e($data->no_pembayaran); ?>" target="blank" class="btn btn-primary m-1">KLIK UNTUK BAYAR VIA SHOPEEPAY</a></td>
                            </kbd>
                            <?php else: ?>
                             <kbd class="bg-dark" data-toggle="tooltip" data-placement="bottom" id="paycode" title="Click to copy" style="margin-left: 50px;"><?php echo e($data->no_pembayaran); ?>
                        ...
                        <div class="mb-4 flex justify-center">
                            <button type="button" class="inline-flex items-center rounded-full border border-transparent px-6 py-3 text-sm font-semibold leading-4 shadow-sm focus:outline-none" onclick="window.location.href='<?php echo e($data->no_pembayaran); ?>'">Unduh kode QR</button>
                        </div>
                        <?php elseif(Str::upper($data->metode_pembayaran) == "OVO" || Str::upper($data->metode_pembayaran) == "GOPAY"): ?>
                        <div class="mb-4 flex justify-center">
                ...
                <div class="lg:min-w-0 lg:flex-1">
                    <div class="h-full py-6">
                        <div class="flex flex-col lg:flex-row md:flex-row gap-3 lg:gap-0 md:gap-0 justify-between rounded-2xl p-6 shadow-sm css-scrciq">
                            <div>
                                <h5 class="font-medium" style="color: rgb(203, 203, 203);">Tanggal Pembelian</h5>
                                <h5 class="font-bold text-sm"><?php echo e($data->created_at); ?></h5>
                            </div>
                            <div>
                                <h5 class="font-medium" style="color: rgb(203, 203, 203);">Nomor Pesanan</h5>
                                <h5 class="font-bold text-sm"><?php echo e($data->id_pembelian); ?></h5>
                            </div>
                            <div>
                                <h5 class="font-medium" style="color: rgb(203, 203, 203);">Metode Pembayaran</h5>
                                <h5 class="font-bold text-sm"><?php echo e($data->metode_pembayaran); ?></h5>
                            </div>
                            <div>
                                <h5 class="font-medium" style="color: rgb(203, 203, 203);">Status Pesanan</h5>
                                <h5 class="font-bold text-sm">
                            <b>
                                <?php if($data->status_pembelian == "Pending"): ?>
                                <span class="text-warning">PENDING</span>
                                <?php elseif($data->status_pembelian == "Process"): ?>
                                <span class="text-info">PROCESS</span>
                                <?php elseif($data->status_pembelian == "Batal"): ?>
                            ...
                            <div class="border-t border-[#626274]">
                                <dl class="border-b border-[#626274] p-4 pb-8">
                                    ...
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        ...
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-0"><?php echo e($data->layanan); ?></dd>
                                    </div>
                                    <?php if($data->tipe_transaksi == "joki"): ?>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">Email Joki</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data_joki->email_joki); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">Password Joki</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data_joki->password_joki); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">Via Login Joki</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data_joki->loginvia_joki); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">Catatan Joki</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data_joki->catatan_joki); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">Request Joki</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data_joki->request_joki); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">Jumlah Joki</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data_joki->jumlah_joki); ?></dd>
                                    </div>
                                    <?php else: ?>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">ID User</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data->user_id); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">ID Zone</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data->zone != null ?"(".$data->zone.")" : ''); ?></dd>
                                    </div>
                                    <div class="py-2 sm:grid sm:grid-cols-3 sm:gap-3 sm:py-2">
                                        <dt class="text-sm font-medium">SN/Keterangan</dt>
                                        <dd class="mt-1 text-sm font-bold sm:col-span-2 sm:mt-"><?php echo e($data->keterangan); ?></dd>
                                    </div>
                        ...
                        <div class="px-3 pt-3 pb-3 text-sm collapse" id="meltih" class="collapse" aria-labelledby="HeadingThreee" data-bs-parent="#Accordione">
                          <ul>
                            <li class="whitespace-pre-line">
                              ...
                              3. Pilih gambar QRIS yang Kamu Download Atau Screenshot Di <?php echo e(config('app.name')); ?> Yang telah disimpan di galeri.
...
<!--// <script>-->
<!--//     setTimeout(function() {-->
<!--//         var statusPembelian = "<?php echo e($data->status_pembelian); ?>";-->
...
<?php echo $__env->make("main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/invoice.blade.php ENDPATH**/ ?>